...
class PocketTTS:
    ...
    def __init__(
        ...
        self.tokenizer.Load(str(self.models_dir / "tokenizer.model"))
        ...
        self._voice_cache = {}
        self._voice_emb = self._get_voice_embeddings(voice)
    ...
    def _load_audio(self, path: Union[str, Path]) -> np.ndarray:
        ...
        if sr != self.SAMPLE_RATE:
            ...
            audio: np.ndarray = scipy.signal.resample(audio, num_samples) #type:ignore
